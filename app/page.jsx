...
export default function Home() {
  ...
  async function handleSelection(event){
    ...
    let parts = await fetch(`http://168.96.149.39:3000/api/associated/${field}`)
  ...
  useAsyncEffect(async ()=>{
    ...
    let parts = await fetch("http://168.96.149.39:3000/api/parts/")
    parts = (await parts.json())?.data 
  ...
  useAsyncEffect(async ()=>{
    ...
    if(selectedPart){
      ...
      let metadata = await fetch(`http://168.96.149.39:3000/api/table/${selectedPart}`)
