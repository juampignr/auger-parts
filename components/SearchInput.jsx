...
export const SearchInput = ({label,nFields}) => {
    ...
    useAsyncEffect(async ()=>{
        ...
        if(isOpen){
            ...
            let parts = await fetch(`http://parts.auger.org.ar/api/associated/${field.current}`)
            ...
            onSelectionChange={(key) => { 
                ...
                if(Object.values(rowsValues).length === fieldsNumber){
                    ...
                    timeoutID.current = setTimeout(async ()=>{
                        ...
                        const postResult = await fetch(`http://parts.auger.org.ar/api/table/${fieldTable.current}`,{
                            method: 'POST',
                            body: formData,
                        })
